...
-- PAL B&W BRAM Video IP  --  Lite v2
-- =====================================
--
-- Extends pal_tv_bram_lite with two additional gradient selections
-- where the last zone (rightmost / bottom) returns to black.
--
-- sel 0  Vertical bars
...
end entity pal_tv_bram_lite_v2;
